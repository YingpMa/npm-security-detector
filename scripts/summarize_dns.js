...
const dir = path.join(__dirname, "dns_results");
if (!fs.existsSync(dir)) {
  console.error("dns_results directory not found");
  process.exit(1);
}
...
console.log("---- DNS scan summary ----");
console.log(`Total DNS result files: ${total}`);
