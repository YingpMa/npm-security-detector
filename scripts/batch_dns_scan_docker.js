// Runs each package inside a Docker sandbox, installs it, captures DNS/SNI traffic with tshark, and saves the domains to JSON. Used for batch dynamic network scanning.
